#!/bin/bash
#SBATCH --job-name tt100k_pred_train_no_aug
...
nvidia-smi
cd ~/M5/yolov3
python3 test.py --cfg cfg/tt100k.cfg --data-cfg data/tt100k_data/tt100k_predict_train.data --weights weights/tt100k_no_data/latest.pt --dataset_name tt100k_predict_train_no_aug --save-json
