#!/bin/bash
#SBATCH --job-name uda_pred_train_no_aug
...
nvidia-smi
cd ~/M5/yolov3
python3 test.py --cfg cfg/udacity.cfg --data-cfg data/udacity_data/udacity_predict_train.data --weights weights/udacity_no_data/latest.pt --dataset_name udacity_predict_train_no_data --save-json
