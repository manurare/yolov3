#!/bin/bash
#SBATCH --job-name coco_pred_train
...
nvidia-smi
cd ~/M5/yolov3
python3 test.py --cfg cfg/yolov3.cfg --data-cfg data/coco_predict_train.data --weights weights/yolov3.weights --dataset_name coco_predict_train
