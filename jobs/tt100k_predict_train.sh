#!/bin/bash
#SBATCH --job-name tt100k_pred_train
...
nvidia-smi
cd ~/M5/yolov3
python3 test.py --cfg cfg/tt100k.cfg --data-cfg data/tt100k_data/tt100k_predict_train.data --weights weights/tt100k_data_augmentation/backup100.pt --dataset_name tt100k_predict_train --save-json
